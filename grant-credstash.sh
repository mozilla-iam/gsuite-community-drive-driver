...
role_arn="`aws iam get-role --role-name gsuite-driver-dev-us-west-2-lambdaRole --query Role.Arn --output text`"
constraints="EncryptionContextEquals={app=gsuite-driver}"
