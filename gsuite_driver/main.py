...
### BEGIN COMMENTED OUT BLOCK FROM EIS-2419 ###
# import socket
# import re
...
### END COMMENTED OUT BLOCK FROM EIS-2419 ###
...
def handle(event=None, context={}):
    ...
    ## START OF DISABLING FUNCTIONALITY UNTIL CISv2 ##
    ## https://jira.mozilla.com/browse/EIS-2419
    logger.info("Exiting function early due to CISv1 deprecation")
    return 200
