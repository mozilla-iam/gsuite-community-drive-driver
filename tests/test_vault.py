...
class VaultTest(unittest.TestCase):
    ...
    def test_person_object(self):
        ...
        grouplist = p.grouplist(filter=config('prefix', namespace='gsuite_driver', default='mozilliansorg'))
        ...
        logger.info('The number of groups with valid members was: {}'.format(good_groups))
